...
export default function TransactionsScreen() {
  const { currentProfileId, incomeData, outcomeData, refreshIncomeData, refreshOutcomeData, refreshCategoryData, refreshProfileData } =
    useAppContext();
  ...
  return (
    <View style={styles.container}>
      <LinearGradient colors={["#4B00B8", "#20014E"]} style={styles.gradientContainer}>
        <BillyHeader />
        <View style={styles.contentContainer}>{memoizedTransactionList}</View>
      </LinearGradient>
    </View>
  );
}
